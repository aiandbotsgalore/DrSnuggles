...
Our latest models feature [native audio output](/gemini-api/docs/models#gemini-2.5-flash-native-audio), which provides natural, realistic-sounding speech and improved multilingual performance. Native audio also enables advanced features like [affective (emotion-aware) dialogue](/gemini-api/docs/live-guide#affective-dialog), [proactive audio](/gemini-api/docs/live-guide#proactive-audio) (where the model intelligently decides when to respond to input), and ["thinking"](/gemini-api/docs/live-guide#native-audio-output-thinking).
...
The latest native audio output model `gemini-2.5-flash-native-audio-preview-09-2025` supports [thinking capabilities](/gemini-api/docs/thinking), with dynamic thinking enabled by default.
