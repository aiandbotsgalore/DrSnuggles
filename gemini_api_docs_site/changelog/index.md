...
*   Released Gemini 3 Pro Image Preview, `gemini-3-pro-image-preview`, the next iteration to the Nano Banana model. Read the [Image generation](/gemini-api/docs/image-generation) page for more details.
...
*   Launched the first Gemini 3 series model, `gemini-3-pro-preview`, our state-of-the-art reasoning and multimodal understanding model with powerful agentic and coding capabilities.
    ...
    *   [Thinking levels](/gemini-api/docs/thinking#thinking-levels)
    ...
    Read the [Gemini 3 Developer Guide](/gemini-api/docs/gemini-3) for migration, new features, and specs.
...
*   The following model is shut down:
    ...
    *   `imagen-3.0-generate-002`
    ...
    Use [Imagen 4](/gemini-api/docs/imagen#imagen-4) instead. Refer to the [Gemini deprecations table](/gemini-api/docs/deprecations) for more details.
    

## November 6, 2025

*   Launched the File Search API to public preview, enabling developers to ground responses in their own data. Read the new [File Search](/gemini-api/docs/file-search) page for more info.

## November 4, 2025

*   For [Gemini 2.5 Flash Image](/gemini-api/docs/image-generation), the input token count for images has been reduced from 1290 to 258, lowering the cost of image editing.
...
*   Launched the new [logging and datasets](/gemini-api/docs/logs-datasets) tool for the Gemini API.
...
*   **Grounding with Google Maps** is now generally available. For more information, see [Grounding with Google Maps](/gemini-api/docs/maps-grounding) documentation.

## October 15, 2025

*   Released [Veo 3.1 and 3.1 Fast](/gemini-api/docs/video#veo-3.1) models in public preview, with new features including:
...
*   Released Gemini Robotics-ER 1.5 model in preview. See the [Robotics overview](/gemini-api/docs/robotics-overview) to learn about how to use the model for your robotics application.
...
*   Deprecation announcement: The following models will be shut down in October 2025:
    ...
    *   `gemini-embedding-exp-03-07` (`gemini-embedding-exp`)
    ...
    See the [Embeddings](/gemini-api/docs/embeddings) page for details on the latest embeddings model.
    

## September 10, 2025

*   Released support for the [Embeddings model in Batch API](/gemini-api/docs/batch-api#batch-embedding), and added Batch API to the [OpenAI compatibility library](/gemini-api/docs/openai#batch) for even easier ways to get started with batch queries.

## September 9, 2025

*   Launched Veo 3 and Veo 3 Fast GA, with lower pricing and new options for aspect ratios, resolution, and seeding. Read the [Veo documentation](/gemini-api/docs/video#model-features) for more information.

## August 26, 2025

*   Launched [Gemini 2.5 Image Preview](/gemini-api/docs/models#gemini-2.5-flash-image-preview), our latest native image generation model.

## August 18, 2025

*   Released [URL context tool](/gemini-api/docs/url-context) to general availability (GA), a tool for providing URLs as additional context to prompts. Support for using URL context with the `gemini-2.0-flash` model (available during experimental release) will be discontinued in one week.

## August 14, 2025

*   Released Imagen 4 Ultra, Standard and Fast models as generally available (GA). To learn more, see the [Imagen](/gemini-api/docs/imagen) page.

## August 7, 2025

*   `allow_adult` setting in Image to Video generation are now available in restricted regions. See the [Veo](/gemini-api/docs/video?example=dialogue#veo-model-parameters) page for details.
...
*   Released `gemini-2.5-flash-lite`, our fast, low-cost, high-performance Gemini 2.5 model. To learn more, see [Gemini 2.5 Flash-Lite](/gemini-api/docs/models#gemini-2.5-flash-lite).

## July 17, 2025

*   Launched `veo-3.0-generate-preview`, the latest update to Veo introducing video with audio generation. To learn more about Veo 3, visit the [Veo](/gemini-api/docs/video) page.
    
*   Increased rate limits for Imagen 4 Standard and Ultra. Visit the [Rate limits](/gemini-api/docs/rate-limits) page for more details.
    

## July 14, 2025

*   Released `gemini-embedding-001`, the stable version of our text embedding model. To learn more, see [embeddings](/gemini-api/docs/embeddings). The `gemini-embedding-exp-03-07` model will be deprecated on August 14, 2025.

## July 7, 2025

*   Launched Gemini API Batch Mode. Batch up requests and send them to process asynchronously. To learn more, see [Batch Mode](/gemini-api/docs/batch-mode).
...
*   The last available tuning model, Gemini 1.5 Flash 001, has been shut down. Tuning is no longer supported on any models. See [Fine tuning with the Gemini API](/gemini-api/docs/model-tuning).
...
*   Added support for prompting with text, image, and audio data, also known as *multimodal* prompting. To learn more, see [Prompting with media](/gemini-api/docs/prompting_with_media).
