...
You can use Grounding with Google Search with other tools like [code execution](/gemini-api/docs/code-execution) and [URL context](/gemini-api/docs/url-context) to power more complex use cases.
