...
*   The *minimum* input token count for context caching is 1,024 for 2.5 Flash, 4,096 for 2.5 Pro and 2,048 for 3 Pro Preview. The *maximum* is the same as the maximum for the given model. (For more on counting tokens, see the [Token guide](/gemini-api/docs/tokens)).
